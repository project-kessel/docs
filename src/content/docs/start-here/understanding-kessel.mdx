...
Kessel provides the primitives to deliver these capabilities, at scale, without reinventing them. It has two main components: **Kessel Inventory** for tracking resources and their relationships, and **Kessel RBAC**, an opinionated but highly reusable access control and tenancy model so you can get right to work on what's valuable.
...
2. **Inventory stores the resource** and replicates permission-relevant relationships to the RBAC authorization graph.
