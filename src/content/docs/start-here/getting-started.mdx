...
<Tabs>
  <TabItem label="Docker compose">
    ...
    2. Start Relations and SpiceDB
        ...
        <Aside type="note">
        The [zed CLI](https://authzed.com/docs/spicedb/getting-started/installing-zed) is required to load the schema into SpiceDB.
        </Aside>
...
<Steps>
    0. Install gRPCurl
        gRPCurl is like curl, but for gRPC. See [the docs](https://github.com/fullstorydev/grpcurl) for more ways to install.
        ```bash
