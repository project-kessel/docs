...
1. Link workspace to role binding
	...
	localhost:9000 \
	kessel.relations.v1beta1.KesselTupleService.CreateTuple
        ```
...
4. Link the user sarah to the role binding
    ```bash
    MESSAGE='{"filter":{"resource_id":"it_team_a","resource_type":"role_binding","resource_namespace":"rbac","relation":"subject","subject_filter":{"subject_type":"principal","subject_namespace":"rbac","subject_id":"sarah"}}}'    
    grpcurl -plaintext -d $MESSAGE \
	localhost:9000 \
...
<Tabs syncKey="language">
  <TabItem label="grpcurl">
  ```bash
  MESSAGE=MESSAGE='{"object": {"resourceType": "host", "resourceId": "dd1b73b9-3e33-4264-968c-e3ce55b9afec", "reporter": {"type": "hbi", "instanceId": "3088be62-1c60-4884-b133-9200542d0b3f"}}, "relation": "t_workspace", "subject": {"resource": {"resourceType": "workspace", "resourceId": "a64d17d0-aec3-410a-acd0-e0b85b22c076", "reporter": {"type": "rbac", "instanceId": "3088be62-1c60-4884-b133-9200542d0b3f"}}}}'
  grpcurl -plaintext -d $MESSAGE \                                                                   
localhost:9081 \
