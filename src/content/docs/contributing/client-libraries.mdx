...
The _suffixes_ of these imports SHOULD be consistent from language to language (aside from language-specific delimiters). These packages are documented in detail following the links to API reference:
