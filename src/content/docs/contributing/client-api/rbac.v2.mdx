  ...
  functions:
    ...
    - name: principalFromRHIdentity
      description: |
        ...
        **Supported identity types:**
        ...
        |------|----------------|
        | `User` | `user.user_id` |
        | `ServiceAccount` | `service_account.user_id`, `service_account.client_id` |
        ...
        [principalSubject](#function-principalSubject).

        Example:

        ```python
        from kessel.rbac.v2 import principalFromRHIdentity
    ...
    - name: principalFromRHIdentityHeader
      description: |
        ...
        ```python
        from kessel.rbac.v2 import principalFromRHIdentityHeader
