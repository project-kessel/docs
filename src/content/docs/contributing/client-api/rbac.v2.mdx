...
package:
  ...
  functions:
    ...
    - name: principalFromIdentity
      description: |
        ...
        **Supported identity types:**
        ...
        ```python
        from kessel.rbac.v2 import principalFromIdentity
        ...
        subject = principalFromIdentity(identity)
        ...
        subject = principalFromIdentity(sa_identity)
        ```
      ...
      params:
        - name: identity
          ...
          description: |
            ...
            [principalFromIdentityHeader](#function-principalFromIdentityHeader)
    ...
    - name: principalFromIdentityHeader
      description: |
        ...
        ```python
        from kessel.rbac.v2 import principalFromIdentityHeader

        # Directly from the HTTP header
        header = request.headers["x-rh-identity"]
        subject = principalFromIdentityHeader(header)
