          ...
          params:
            - name: target
              ...
              description: | 
                ...
                **Implementation note:** There are currently no other defaults that should be set
                outside of gRPC defaults, in general. Python should enable use of single-threaded
                unary streams when asyncio is not used.
      methods:
        ...
        - name: build
          description: Constructs the generated stub for the package's service and version following the builder's configuration.
          returns:
            name: "{Service}Stub"
        - name: buildAsync
