  ...
  functions:
    - name: get_root_workspace
      description: |
        ...
        ISSUER_URL = "https://sso.example.com/auth/"
      ...
      params:
        - name: oauth_credentials
          type:
            ...
            link: ../auth/#class-OAuth2ClientCredentials
          description: |
            OAuth2 client credentials for automatic authentication. Using getToken() to retrieve a token for the http request.
        ...
        - name: org_id
          type:
            name: string
          description: |
            Organization ID to use for the request. Will be encoded in the x-rh-rbac-org-id header in the http request.
      returns:
        name: "Dict[str, Any]"
        description: |
