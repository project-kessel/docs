...
| Named or positional parameters | In general, the use of named or positional parameters (arguments) is up to the SDK author. Prefer named parameters in general where possible, especially for ambiguous or primitive types (like booleans) which make the code harder to read. |
