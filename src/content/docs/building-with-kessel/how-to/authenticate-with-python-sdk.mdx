...
- [SDK reference](/building-with-kessel/reference/sdk-reference/) — entry point under Building with Kessel for SDK docs
- [Client SDK specification](/contributing/client-libraries/) — standard for client library authors
- [Package spec: auth](/contributing/client-api/auth/) — auth package contract
- [Package spec: grpc](/contributing/client-api/grpc/) — gRPC utilities contract