...
async def get_integration(
    integration_id: str,
    permitted: bool = Depends(lambda: check_permission("myservice_integration_view"))
):
    return {"integration_id": integration_id, "name": "Example Integration"}
...
async def update_integration(
    integration_id: str,
    permitted: bool = Depends(lambda: check_permission("myservice_integration_edit"))
):
    return {"status": "updated"}
```
...
get '/integrations/:id' do
  require_permission('myservice_integration_view')
  { integration_id: params[:id], name: 'Example Integration' }.to_json
end

put '/integrations/:id' do
  require_permission('myservice_integration_edit')
    ...
    private String getRequiredRelation(HttpServletRequest request) {
        ...
        if (path.startsWith("/integrations/")) {
            if ("GET".equals(method)) {
                return "myservice_integration_view";
            } else if ("PUT".equals(method) || "POST".equals(method) || "DELETE".equals(method)) {
                return "myservice_integration_edit";
            }
        }
