...
<Aside type="tip" title="Looking for a specific term?">
  The [RBAC v1 to v2 concept map](/docs/building-with-kessel/reference/v1-v2-concept-map/) is a single-page lookup table covering every v1 concept and its v2 equivalent, including the ones that do not map 1:1. Use it to answer "what is the v2 version of X?"; use this page to understand why the answer is what it is.
</Aside>
...
<LinkCard
  ...
  description="Lookup table mapping each v1 concept to its v2 equivalent, with the non-1:1 cases called out."
